...
struct empleados
{
	string codigoEmpleado, nombreEmpleado, apellidoEmpleado, puestoEmpleado, estadoEmpleado, nuevoEstadoLab, codigoBusqueda, confirmarModificacion, nuevoNombre, nuevoApellido, nuevoPuesto;
				...
				if (!baseUsuarios.eof())
				{
					if (datosUsuarios.codigoUsuario == datosUsuarios.codigoBusqueda)
					{
						...
						if (datosUsuarios.contrasenaUsuario == datosUsuarios.contrasenaBusqueda)
						{
							do {
								system("cls");
								gotoxy(30, 5);cout << "Ingrese la opcion deseada";
								gotoxy(30, 6);cout << "Altas				1";
								gotoxy(30, 7);cout << "Bajas				2";
								gotoxy(30, 8);cout << "Salir				0";
								gotoxy(64, 9);cin >> opcion;
								switch (opcion)
								{
								case 1:
									system("cls");
